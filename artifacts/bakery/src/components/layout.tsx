...
import {
  ...
  PackageCheck, Activity, Receipt, Users2, DoorOpen, ClipboardCheck, ClipboardList,
} from "lucide-react";
...
const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/stock-identity-review", label: "Product Review", icon: ClipboardList, roles: ["managing_director","manager"] },
